...
namespace Pokemon.Area
{
    public class Area
    {
        ...
        // TileTypes
        public readonly string Border = AreaSettings.Border;
        public readonly string Empty = AreaSettings.Empty;
        public readonly string Tree = AreaSettings.Tree;
        public readonly string Grass = AreaSettings.Grass;
        public readonly string Person = AreaSettings.Person;
